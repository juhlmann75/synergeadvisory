...
<div class="container" style="margin-top: 75px;margin-bottom: 75px;font-size:12pt;width:80%">
	<h1>Synergos Advisory's Flat-Fee<br>Ongoing Financial Planning</h1>
      ...
      <div class="row" style="margin-bottom:50px;margin-top:100px;">
        ...
        <div class="col-md-1"><div style="margin-top:90px;margin-bottom:46px;font-size: 20pt;font-weight: bold;">+</div></div>
        <div class="col-md-2">
