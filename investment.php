...
.container {
  ...
  <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <img class="img-fluid rounded mb-3 mb-md-0" src="files/images/investment-1.jpeg" alt="" width="525" height="300">
        </div>
      </div>
      <!-- /.row -->
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="taxes-text" style="margin-top:-8px;">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <img class="img-fluid rounded mb-3 mb-md-0" src="files/images/investment-2.png" alt="" width="525" height="300">
        </div>
      </div>
      <!-- /.row -->
