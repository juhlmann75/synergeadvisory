   ...
   <div class="container" style="margin-top: 75px;">
    ...
    <div class="row">
      ...
      <div class="col-lg-4" >
		...
		<br><br>
		David R. Uhlmann,  Synergos Advisory Founder
      </div>
    ...
    <div class="row">
      <div class="col-lg-8">
        ...
        <div class="container">
            ...
            <ul>
                <li class="serviceList">Master of Science, Finance, Golden Gate University</li>
                <li class="serviceList">Bachelor of Arts, Economics and International Relations, University of California, Davis</li>
            </ul>
        </div>
      </div>
      <div class="col-lg-4">
        <div class="fb-page" data-href="https://www.facebook.com/synergosadvisoryllc" data-tabs="timeline" data-width="" data-height="450" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/synergosadvisoryllc" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/synergosadvisoryllc">Synergos Advisory LLC</a></blockquote></div>
      </div>
    </div>
       
       
    <div class="container" style="margin-bottom:20px;">
        <h4 style="text-align:left">Previous Experience</h4>
        <hr>
        <ul>
